...
- Salting adalah teknik pertahanan di mana data acak (salt) ditambahkan ke input password sebelum di-hash. Hal ini memastikan bahwa dua user dengan password yang sama akan memiliki hash yang berbeda, sehingga menggagalkan serangan menggunakan Rainbow Table atau Dictionary Attack massal.
