...
## 3. Alat dan Bahan
- Python 3.x: Bahasa pemrograman untuk menjalankan skrip.
- Visual Studio Code: Code editor untuk menulis dan menjalankan kode.
...
5. Mengamati output pada terminal untuk melihat proses mining dan hash yang dihasilkan.
---
...
## 8. Kesimpulan
Percobaan ini berhasil mendemonstrasikan cara kerja dasar blockchain, yaitu struktur data blok yang saling terkait dan mekanisme Proof of Work (PoW). Dapat disimpulkan bahwa PoW efektif untuk mengamankan data dengan mempersulit pembuatan blok melalui kriteria kesulitan (difficulty) hash, namun integritas rantai sangat bergantung pada validasi hash dari blok sebelumnya.
---
